...
| **Licence / Terms** | Statistics Canada Open Licence — https://www.statcan.gc.ca/en/reference/licence | OGL-Canada 2.0 (open.canada.ca dataset) / CRA web terms for web search interface | OGL-Canada 2.0 — https://open.canada.ca/en/open-government-licence-canada | OGL-Canada 2.0 — https://open.canada.ca/en/open-government-licence-canada | OGL-Canada 2.0 — https://open.canada.ca/en/open-government-licence-canada | OGL-Canada 2.0 — https://open.canada.ca/en/open-government-licence-canada | Parliament of Canada website terms — parl.gc.ca/SiteInformation/Terms (OGL-Canada does not apply) |
| **Licence Status** | **Approved** (Statistics Canada Open Licence confirmed — CV-SRC-REV-001 v0.2) | **Approved** (OGL-Canada 2.0 — open.canada.ca path — CV-SRC-REV-002 v0.2) | **Approved** (OGL-Canada 2.0 confirmed — CV-SRC-REV-003 v0.2) | **Approved** (OGL-Canada 2.0 confirmed — CV-SRC-REV-004 v0.2) | **Approved** (OGL-Canada 2.0 — CV-SRC-REV-005 v0.2) | **Approved** (OGL-Canada 2.0 — CV-SRC-REV-006 v0.2) | **Public Registry** (Parliament website terms — CV-SRC-REV-007 v0.2) |
...
| **Notes** | **Step 23 (2026-08-02):** Licence Approved (Statistics Canada Open Licence). Source owner confirmed. Attribution: "Source: Statistics Canada, [Dataset name], [reporting period]. Adapted from Statistics Canada under the Statistics Canada Open Licence." **Blocking:** Specific dataset(s)/indicators not yet defined — source URL at dataset level, reporting period, and fetch method are TBD. See CV-SRC-REV-001 v0.2. | **Step 24 (2026-08-02):** Licence Approved (OGL-Canada 2.0 — open.canada.ca path). Source owner confirmed (CRA). open.canada.ca registered charities dataset is preferred path — confirm exact dataset ID at fetch. Attribution: "Source: Canada Revenue Agency — Registered Charities database, Government of Canada (open.canada.ca). Contains information licensed under the Open Government Licence – Canada. Data reflects T3010 filings for [fiscal year]. Fetched [date]." Display rules: factual status, registration number, name, and category only; do not display director names without separate privacy assessment; no charity effectiveness ratings. See CV-SRC-REV-002 v0.2. | **Step 23 (2026-08-02):** Licence Approved (OGL-Canada 2.0). Source URLs confirmed. Preferred path: Fiscal Reference Tables XLSX. Attribution: "Source: Department of Finance Canada — Federal Budget [year], Government of Canada. Contains information licensed under the Open Government Licence – Canada. Fetched [date]." Reporting year and fetch date TBD. See CV-SRC-REV-003 v0.2. | **Step 23 (2026-08-02):** Licence Approved (OGL-Canada 2.0). Source URLs confirmed. Preferred path: proactive disclosure grants/contributions CSV on open.canada.ca (confirm dataset ID). Attribution: "Source: Receiver General for Canada — Public Accounts of Canada [fiscal year], Government of Canada. Contains information licensed under the Open Government Licence – Canada. Fetched [date]." Reporting year and fetch date TBD. See CV-SRC-REV-004 v0.2. | **Step 24 (2026-08-02):** Licence Approved (OGL-Canada 2.0). Source owner confirmed (Office of the Commissioner of Lobbying of Canada). Bulk CSV download available at lobbycanada.gc.ca/en/open-data/ — confirm exact file URL at fetch. Attribution: "Source: Office of the Commissioner of Lobbying of Canada — Registry of Lobbyists (lobbycanada.gc.ca). Contains information licensed under the Open Government Licence – Canada. Data current as of [fetched date]." **HIGH-RISK:** Named lobbyists and DPOHs — second reviewer required before named-DPOH or communication-report data is displayed. Must not infer influence, corruption, or misconduct. CV-REG-002 update required before Firestore write. See CV-SRC-REV-005 v0.2. | **Step 24 (2026-08-02):** Licence Approved (OGL-Canada 2.0). Source owner confirmed (Elections Canada). Machine-readable: Yes (election results CSV/XML); Partial (campaign finance). 45th General Election results available on elections.ca — confirm specific open data file URL. Attribution (election results): "Source: Elections Canada — [Election name] results (elections.ca). Contains information licensed under the Open Government Licence – Canada. Fetched [date]." Attribution (campaign finance): "Source: Elections Canada — Political Entities Financial Returns (elections.ca). Contains information licensed under the Open Government Licence – Canada. Financial return data for [election/fiscal year]. Fetched [date]." **HIGH-RISK:** Second reviewer required for named donor / campaign finance display. CV-REG-002 update required. See CV-SRC-REV-006 v0.2. | **Step 24 (2026-08-02):** Classified as Public Registry (Parliament website terms). Source owner confirmed (Office of the Conflict of Interest and Ethics Commissioner). Machine-readable: No — PDF/HTML only. Manual Review Only — no automated pipeline. Attribution: "Source: Office of the Conflict of Interest and Ethics Commissioner of Canada (ciec-ccie.parl.gc.ca). [Report name and date]. [Direct link to official report.]" **HIGHEST RISK:** Second reviewer mandatory per record; must link to official report for every displayed finding; no paraphrase or editorialization. CV-REG-002 update required. See CV-SRC-REV-007 v0.2. |
...
| **Licence / Terms** | Open Government Licence – Ontario — https://www.ontario.ca/page/open-government-licence-ontario | Open Government Licence – Ontario — https://www.ontario.ca/page/open-government-licence-ontario | Open Government Licence – Ontario — https://www.ontario.ca/page/open-government-licence-ontario | Ontario Legislature / officer-of-legislature website terms — confirm oico.on.ca terms of use (OGL-Ontario does not automatically apply) |
| **Licence Status** | **Approved** (OGL-Ontario confirmed — CV-SRC-REV-008 v0.2) | **Approved** (OGL-Ontario confirmed — CV-SRC-REV-009 v0.2) | **Approved** (OGL-Ontario — CV-SRC-REV-010 v0.2) | **Public Registry** (Ontario Legislature / oico.on.ca terms — CV-SRC-REV-011 v0.2) |
...
| **Notes** | **Step 23 (2026-08-02):** Licence Approved (OGL-Ontario). Source URLs confirmed: ontario.ca/page/ontario-budget and data.ontario.ca. Preferred path: data.ontario.ca CSV/XLSX if available for applicable year; fallback: PDF. Attribution: "Source: Ontario Ministry of Finance — Ontario Budget [year], Government of Ontario. Contains information licensed under the Open Government Licence – Ontario. Fetched [date]." Confirm data.ontario.ca availability for applicable budget year. Reporting year and fetch date TBD. See CV-SRC-REV-008 v0.2. | **Step 23 (2026-08-02):** Licence Approved (OGL-Ontario). Source URLs confirmed: ontario.ca/page/public-accounts and data.ontario.ca. Preferred path: data.ontario.ca transfer payments CSV (machine-readable: Yes). Attribution: "Source: Government of Ontario — Transfer Payments and Grants [fiscal year], data.ontario.ca. Contains information licensed under the Open Government Licence – Ontario. Fetched [date]." Confirm exact dataset URL on data.ontario.ca. Reporting year and fetch date TBD. See CV-SRC-REV-009 v0.2. | **Step 24 (2026-08-02):** Licence Approved (OGL-Ontario). Source owner confirmed (Government of Ontario — Treasury Board Secretariat). Machine-readable: Yes (data.ontario.ca CSV). Confirm exact dataset URL and calendar year at fetch. Attribution: "Source: Government of Ontario — Public Sector Salary Disclosure [year] (data.ontario.ca). Contains information licensed under the Open Government Licence – Ontario. Fetched [date]." **HIGH-RISK:** Named individuals with salary amounts. Second reviewer required. Ontario Privacy Commissioner guidance must be reviewed before display. Must display exact disclosed figures only — no rounding, estimation, or editorial commentary on salary fairness. CV-REG-002 update required. See CV-SRC-REV-010 v0.2. | **Step 24 (2026-08-02):** Classified as Public Registry (Ontario Legislature / oico.on.ca terms). Source owner confirmed (Office of the Integrity Commissioner of Ontario). Machine-readable: No — PDF/HTML only. Manual Review Only — no automated pipeline. Attribution: "Source: Office of the Integrity Commissioner of Ontario (oico.on.ca). [Report name and date]. [Direct link to official report.]" **HIGHEST RISK:** Second reviewer mandatory per record; must link to official oico.on.ca report for every displayed finding; no paraphrase or editorialization. CV-REG-002 update required. See CV-SRC-REV-011 v0.2. |
...
**CRA Charities:** *(Licence: Approved — OGL-Canada 2.0, open.canada.ca path)*
> "Source: Canada Revenue Agency — Registered Charities database, Government of Canada (open.canada.ca). Contains information licensed under the Open Government Licence – Canada. Data reflects T3010 filings for [fiscal year]. Fetched [date]."
...
**Lobbying Registry:** *(Licence: Approved — OGL-Canada 2.0)*
> "Source: Office of the Commissioner of Lobbying of Canada — Registry of Lobbyists (lobbycanada.gc.ca). Contains information licensed under the Open Government Licence – Canada. Data current as of [fetched date]."

**Elections Canada:** *(Licence: Approved — OGL-Canada 2.0)*
> *Election results:* "Source: Elections Canada — [Election name] results (elections.ca). Contains information licensed under the Open Government Licence – Canada. Fetched [date]."
>
> *Campaign finance:* "Source: Elections Canada — Political Entities Financial Returns (elections.ca). Contains information licensed under the Open Government Licence – Canada. Financial return data for [election/fiscal year]. Fetched [date]."

**Conflict of Interest and Ethics Commissioner:** *(Licence: Public Registry — Parliament website terms)*
> "Source: Office of the Conflict of Interest and Ethics Commissioner of Canada (ciec-ccie.parl.gc.ca). [Report name and date]. [Direct link to official report.]"
...
**Ontario Sunshine List:** *(Licence: Approved — OGL-Ontario)*
> "Source: Government of Ontario — Public Sector Salary Disclosure [year] (data.ontario.ca). Contains information licensed under the Open Government Licence – Ontario. Fetched [date]."

**Ontario Integrity Commissioner:** *(Licence: Public Registry — Ontario Legislature / oico.on.ca terms)*
> "Source: Office of the Integrity Commissioner of Ontario (oico.on.ca). [Report name and date]. [Direct link to official report.]"
...
| 0.3 | 2026-08-02 | Founder / Data Lead | Step 24 Source Approval Batch 2 — Public Registries and High-Risk Sources: Licence Status updated for all six remaining sources. SRC-FED-002 (CRA Charities) → Approved (OGL-Canada 2.0, open.canada.ca path). SRC-FED-005 (Lobbying Registry) → Approved (OGL-Canada 2.0). SRC-FED-006 (Elections Canada) → Approved (OGL-Canada 2.0). SRC-FED-007 (Federal Ethics Commissioner) → Public Registry (Parliament website terms; Manual Review Only). SRC-ONT-003 (Sunshine List) → Approved (OGL-Ontario). SRC-ONT-004 (Ontario Integrity Commissioner) → Public Registry (Ontario Legislature terms; Manual Review Only). Attribution statements confirmed for all six sources. Licence/Terms cells updated to reflect confirmed terms. High-risk controls documented in Notes for each source. CV-REG-002 update flagged for SRC-FED-005, 006, 007 and SRC-ONT-003, 004. |
